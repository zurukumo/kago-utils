...
def test_decompose_with_normal_tehai():
    ...
    assert len(decomposed_tehais) == 2
    assert decomposed_tehais[0] == [
...
def test_decompose_with_penchan_kanchan_tehai():
